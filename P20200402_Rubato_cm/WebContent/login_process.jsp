<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	...
    	//================DB 연동 (SELECT)==================
    	String sql = String.format("SELECT * FROM rb_member where rbm_id='%s' AND rbm_pw='%s'",id,pw);
...
<%
	if(isSucess){
		...
		//out.println("<a href='./index.jsp'>메인페이지로...</a><br>");
