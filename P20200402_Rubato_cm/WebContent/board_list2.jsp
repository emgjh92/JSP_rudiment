...
Statement stm2 = conn2.createStatement();// 실행 객체- 실행 관련 처리 
...
//로직처리 끝....
      ...
      <form action="./board_list2.jsp" method="post">  <!-- - -->
        <div id="search_input"><input type="text" name="search"></div>
    ...
    <table>
      ...
      // Test Code - 개발자를 위해 log를 찍는 용도
      System.out.println("실행될 쿼리: "+sql0);
...
//------------------------------------------------------------------					
	...
	String rbb_hit = rs0.getNString("rbb_hit");
	out.print("<tr>");
